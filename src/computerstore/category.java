...
public final class category extends javax.swing.JFrame {
     ...
     private final Connection con;
      ...
      private final dbcon dbConnector;
        ...
        if (con != null) {
            ...
            showAllCateg(); // Call the method to display services
        } else {
            System.out.println("Failed to connect to the database.");
        }
    }
 public void showAllCateg() {
       try {
            System.out.println("Fetching services...");
            PreparedStatement SQ = con.prepareStatement("SELECT CAT_ID, CAT_NAME, CAT_TAG FROM CATEGORY;");
            ...
            while (rs.next()) {
                String id_cat = String.valueOf(rs.getInt("CAT_ID"));
                String catName = rs.getString("CAT_NAME");
                String catTag = rs.getString("CAT_TAG");

                String rowData[] = {id_cat, catName, catTag};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CATEGORY OF PRODUCTS");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(search_text, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(36, 36, 36)
 ...
 if (search_text.getText().isEmpty()) {
     ...
     showAllCateg(); // If the search field is empty, show all categoriesshowAllCateg(); 
    } else {
        try {
            ...
            PreparedStatement search = con.prepareStatement("SELECT * FROM CATEGORY WHERE CAT_ID=? OR CAT_NAME=? OR CAT_TAG=?;");
            search.setString(1, search_text.getText());
            search.setString(2, search_text.getText());
            search.setString(3, search_text.getText());

            ResultSet res = search.executeQuery();

            while (res.next()) {
                String idcateg = String.valueOf(res.getInt("CAT_ID"));
                String categName = res.getString("CAT_NAME");
                String categtag = res.getString("CAT_TAG");

                String tableData[] = {idcateg, categName, categtag};
