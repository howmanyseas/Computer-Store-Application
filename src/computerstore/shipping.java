...
public class shipping extends javax.swing.JFrame {
    ...
    public shipping() {
        ...
        if (con != null) {
            ...
            showship(); // Call the method to display services
        } else {
 ...
 public void showship() {
       try {
            ...
            PreparedStatement SQ = con.prepareStatement("SELECT * FROM SHIPPING;");
            ...
            while (rs.next()) {
                String SHIP_ID = String.valueOf(rs.getInt("SHIP_ID"));
                String ORDER_ID = rs.getString("ORDER_ID");
                String SHIP_TR_NO = rs.getString("SHIP_TR_NO");
                String SHIP_DATE = rs.getString("SHIP_DATE");

                String rowData[] = {SHIP_ID, ORDER_ID, SHIP_TR_NO, SHIP_DATE};
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SHIP_ID", "ORDER_ID", "SHIP_TR_NO", "SHIP_DATE"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txt_s, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 if (txt_s.getText().isEmpty()) {
     ...
     showship(); // If the search field is empty, show all categoriesshowAllCateg(); 
    } else {
        try {
            ...
            PreparedStatement search = con.prepareStatement("SELECT * FROM SHIPPING WHERE SHIP_ID=? OR ORDER_ID=? OR SHIP_TR_NO=? OR SHIP_DATE=?;");
            search.setString(1, txt_s.getText());
            search.setString(2, txt_s.getText());
            search.setString(3, txt_s.getText());
            search.setString(4, txt_s.getText());

            ResultSet res = search.executeQuery();

            while (res.next()) {
                String SHIP_ID = String.valueOf(res.getInt("SHIP_ID"));
                String ORDER_ID = res.getString("ORDER_ID");
                String SHIP_TR_NO = res.getString("SHIP_TR_NO");
                String SHIP_DATE = res.getString("SHIP_DATE");

                String tableData[] = {SHIP_ID, ORDER_ID, SHIP_TR_NO, SHIP_DATE};
